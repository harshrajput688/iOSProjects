...
//  slot-machine
//
//  Created by Harsh Rajput on 20/04/23.
//
...
struct ContentView: View {
    ...
    var body: some View {
        ...
        .alert(item: $showingAlert){alert -> Alert in
            ...
            switch alert{
            case .success:
                return Alert(title: Text("Yahh ! you won"), message: Text("won with the charm"), dismissButton: .cancel())
            case .failure:
                return Alert(title: Text("Oooops!"), message: Text("Better Luck Next time"), dismissButton: .cancel())
